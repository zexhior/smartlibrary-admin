...
const AddCategoryModal = ({action='', data = { _id: "",wording :""}})=>{
    ...
    return (<div className='addcategorymodal'> 
        <form onSubmit={(action==='create'?HandlerCreateCategory:HandlerUpdateCategory)}>
            <InputComponent label='Libellé' type='text' placeholder='Libellé' required={true} state={category} name={'wording'} setState={setCategory}/>
            {
